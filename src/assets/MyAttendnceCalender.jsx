...
//           axios.get(`https://server-backend-ems.vercel.app/admin/weeklyoff/${new Date().getFullYear()}`),
//           axios.get(`https://server-backend-ems.vercel.app/getHolidays`),
//           axios.get(`https://server-backend-ems.vercel.app/attendance/regularization/my/${employeeId}`),
//         ]);
