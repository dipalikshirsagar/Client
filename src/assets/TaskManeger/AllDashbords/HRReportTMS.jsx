...
*/
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        const res = await axios.get("https://server-backend-ems.vercel.app/api/projects");
    ...
    const fetchData = async () => {
      try {
        ...
        const [employeesRes, tasksRes, projectsRes] = await Promise.all([
          axios.get("https://server-backend-ems.vercel.app/getAllEmployees", { headers }),
          axios.get("https://server-backend-ems.vercel.app/task/getall", { headers }),
          axios.get("https://server-backend-ems.vercel.app/api/projects", { headers }),
        ]);
