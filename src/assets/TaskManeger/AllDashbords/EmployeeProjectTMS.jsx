...
function EmployeeProjectTMS({ employeeId }) {
  ...
  const fetchProjects = async () => {
    try {
      ...
      const response = await axios.get(`https://server-backend-nu.vercel.app/projects/employee/${employeeId}`);

      if (response.data.success && response.data.projects) {
        const transformedProjects = response.data.projects.map(project => ({
          projectCode: project.projectCode || `PRJ${project._id?.slice(-4)?.toUpperCase() || '0000'}`,
          ...
          assigned: project.assignedDate ? new Date(project.assignedDate).toISOString().split('T')[0] : "N/A",
          due: project.dueDate ? new Date(project.dueDate).toISOString().split('T')[0] : "N/A",
  ...
  const filteredData =
    searchQuery.trim() === ""
      ...
      : projectData.filter((item) => {
        ...
        return (
          // Project Code
          (item.projectCode && item.projectCode.toLowerCase().includes(query)) ||
          // Project Name
          (item.project && item.project.toLowerCase().includes(query)) ||
          // My Role
          (item.myRole && item.myRole.toLowerCase().includes(query)) ||
          // Managers 
          (item.managers && item.managers.some(m => m.toLowerCase().includes(query))) ||
          // Start Date (formatted)
          (item.startDate && formatDateDisplay(item.startDate).toLowerCase().includes(query)) ||
          // End Date (formatted)
          (item.endDate && formatDateDisplay(item.endDate).toLowerCase().includes(query)) ||
          // Progress
  ...
  return (
    <div className="container-fluid " >
      <h2 style={{ color: "#3A5FBE", fontSize: "25px" }}>My Projects</h2>
        ...
        <div className="table-responsive bg-white">
          <table className="table table-hover mb-0">
            <thead style={{ backgroundColor: "#ffffffff" }}>
              <tr>
                <th style={{ fontWeight: '500', fontSize: '14px', color: '#6c757d', borderBottom: '2px solid #dee2e6', padding: '12px', whiteSpace: 'nowrap' }}>Project ID</th>
                ...
                <th style={{ fontWeight: '500', fontSize: '14px', color: '#6c757d', borderBottom: '2px solid #dee2e6', padding: '12px', whiteSpace: 'nowrap' }}>My Role</th>
                <th style={{ fontWeight: '500', fontSize: '14px', color: '#6c757d', borderBottom: '2px solid #dee2e6', padding: '12px', whiteSpace: 'nowrap' }}>Managers</th>
                ...
                <th style={{ fontWeight: '500', fontSize: '14px', color: '#6c757d', borderBottom: '2px solid #dee2e6', padding: '12px', whiteSpace: 'nowrap' }}>End Date</th>
              ...
              {paginatedData.length > 0 ? (
                paginatedData.map((item, index) => (
                  ...
                  >
                    ...
                    <td style={{ padding: '12px', verticalAlign: 'middle', fontSize: '14px', borderBottom: '1px solid #dee2e6', whiteSpace: 'nowrap', color: "#212529" }}>
                      <span className="fw-normal">{item.managers.join(", ")}</span>
                    </td>
                    <td style={{ padding: '12px', verticalAlign: 'middle', fontSize: '14px', borderBottom: '1px solid #dee2e6', whiteSpace: 'nowrap', color: "#212529" }}>
                      <span className="fw-normal">{formatDateDisplay(item.startDate)}</span>
                    </td>
                    <td style={{ padding: '12px', verticalAlign: 'middle', fontSize: '14px', borderBottom: '1px solid #dee2e6', whiteSpace: 'nowrap', color: "#212529" }}>
                      <span className="fw-normal">{formatDateDisplay(item.endDate)}</span>
                    </td>
                ...
                <tr>
                  <td colSpan="7" className="text-center py-4" style={{ color: "#212529" }}>
                    {projectData.length === 0 ? "No projects assigned." : "No projects found matching your search."}
                  </td>
                </tr>
              )}
            </tbody>
              ...
              <div className="modal-body">
                <div className="container-fluid">
                  <div className="row mb-2">
                    <div className="col-5 col-sm-4 fw-semibold" style={{ color: "#212529" }}>Project ID</div>
                    <div className="col-7 col-sm-8" style={{ color: "#212529" }}>{selectedProject.projectCode}</div>
                  </div>

                  <div className="row mb-2">
                    <div className="col-5 col-sm-4 fw-semibold" style={{ color: "#212529" }}>Project Name</div>
                    <div className="col-7 col-sm-8" style={{ color: "#212529" }}>{selectedProject.project}</div>
                  </div>

                  <div className="row mb-2">
                    <div className="col-5 col-sm-4 fw-semibold" style={{ color: "#212529" }}>Description</div>
                    <div className="col-7 col-sm-8" style={{ color: "#212529" }}>{selectedProject.desc}</div>
                  </div>

                  {/* <div className="row mb-2">
                    <div className="col-5 col-sm-4 fw-semibold" style={{ color: "#212529" }}>My Role</div>
                    <div className="col-7 col-sm-8" style={{ color: "#212529" }}>{selectedProject.myRole}</div>
                  </div> */}

                  <div className="row mb-2">
                    <div className="col-5 col-sm-4 fw-semibold" style={{ color: "#212529" }}>Managers</div>
                    <div className="col-7 col-sm-8" style={{ color: "#212529" }}>
                      {selectedProject.managers.join(", ")}
                    </div>
                  </div>

                  <div className="row mb-2">
                    <div className="col-5 col-sm-4 fw-semibold" style={{ color: "#212529" }}>Start Date</div>
                    <div className="col-7 col-sm-8" style={{ color: "#212529" }}>
                  ...
                  <div className="row mb-2">
                    <div className="col-5 col-sm-4 fw-semibold" style={{ color: "#212529" }}>End Date</div>
                    <div className="col-7 col-sm-8" style={{ color: "#212529" }}>
                  ...
                  <div className="row mb-2">
                    <div className="col-5 col-sm-4 fw-semibold" style={{ color: "#212529" }}>Due Date</div>
                    <div className="col-7 col-sm-8" style={{ color: "#212529" }}>
                  ...
                  <div className="row mb-2">
                    <div className="col-5 col-sm-4 fw-semibold" style={{ color: "#212529" }}>Status</div>
                    <div className="col-7 col-sm-8">
                      <span style={getStatusStyle(selectedProject.status)}>
                  ...
                  <div className="row mb-2">
                    <div className="col-5 col-sm-4 fw-semibold" style={{ color: "#212529" }}>Priority</div>
                    <div className="col-7 col-sm-8" style={{ color: "#212529" }}>
