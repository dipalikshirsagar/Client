...
function DelayedTasksTable({ delayedTasks, allEmployees, onClose }) {
  ...
  const filteredTasks = useMemo(() => {
    ...
    return result;
  }, [delayedTasks, searchQuery, allEmployees]);
  ...
  const isNextDisabled = delayedPage >= totalPages || filteredTasks.length === 0;
        ...
        <div className="card-body p-3">
          <div className="d-flex align-items-center gap-3 flex-wrap">
            ...
            <div className="d-flex gap-2 ms-auto">
              <button className="btn btn-sm custom-outline-btn" onClick={() => setDelayedPage(1)}>
                Filter
              </button>
