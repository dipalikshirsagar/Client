    ...
    const fetchData = async () => {
      try {
        const [leaveRes, regRes] = await Promise.all([
          ...
          axios.get(`https://server-backend-nu.vercel.app/attendance/regularization/my/${user._id}`),
      ...
      <div className="row align-items-center">
        <div className="col-md-12">
          ...
          <div className="d-flex align-items-center justify-content-between mb-3">
            <h6 style={{ fontSize: "25px", color: "#3A5FBE", fontWeight: 600, margin: 0 }}>
              Break
            </h6>
            ...
            <i
              ...
              style={{ fontSize: "28px", color: "#3A5FBE", opacity: 0.35 }}
            ></i>
          </div>
 <hr style={{ width: "100%", margin: "10px 0", opacity: "0.2" }} />
          <div className="ms-0">
            {/* Break Type */}
            <div className="d-flex align-items-center gap-2 mb-2">
              <span style={{ minWidth: "80px", color: "#3A5FBE", fontWeight: "600", fontSize: "18px" }}>
                Type :
              </span>
              <select
            ...
            {breakType === "Other" && (
              <div className="d-flex align-items-center mb-2">
                <span style={{ minWidth: "88px", color: "#3A5FBE", fontWeight: "600", fontSize: "18px" }}>
                  Reason :
                </span>
                <input
                  type="text"
            ...
            {/* Break Timer */}
            <div className="d-flex align-items-center mb-2">
              <span style={{ minWidth: "89px", color: "#3A5FBE", fontWeight: "600", fontSize: "18px" }}>Time :</span>
              <span
                style={{
                  fontSize: "18px",
                  fontWeight: "500",
            ...
            <div className="d-flex align-items-center mt-1">
              <span style={{ minWidth: "120px", color: "#3A5FBE", fontWeight: "600", fontSize: "18px" }}>Total Hours :</span>
              <span style={{ fontSize: "18px", fontWeight: "600", color: "#3A5FBE" }}>
            ...
            <div className="d-flex gap-2 mt-3">
              <button
                className={`btn ${onBreak ? "btn-secondary" : "btn-success"}`}
                style={{ minWidth: "130px", height: "40px", borderRadius: "20px" }}
              ...
              <button
                className={`btn px-4 ${!onBreak ? "btn-secondary" : "btn-danger"}`}
                style={{ minWidth: "130px" }}
                disabled={!onBreak || !attendance?.checkIn || attendance?.checkOut}
