...
const EmployeeFeedback = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (!formData.title || !formData.message || (!editId && !formData.receiverId)) {
  ...
  return (
    <div className="container-fluid"  >
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2 style={{ color: "#3A5FBE", fontSize: "25px", marginLeft: "15px" }}>Employee Feedback Dashboard
        </h2>
          ...
          >
            ...
            <div className="col-12 col-md-auto d-flex align-items-center gap-2 mb-1">
              <label htmlFor="searchInput" className="fw-bold mb-0"
                style={{ fontSize: "16px", color: "#3A5FBE", marginRight: "5px", minWidth: "65px" }}>
                Search Feedback
              </label>
              <input
                id="searchInput"
      ...
      <h2 style={{ color: "#3A5FBE", fontSize: "25px", marginLeft: "15px" }}>Feedback Received from HR</h2>
          ...
          >
            <table className="table table-hover mb-0" style={{ borderCollapse: 'collapse' }}>
              <thead style={{ backgroundColor: '#f8f9fa' }}>
                <tr>
                  <th style={{ fontWeight: '500', fontSize: '14px', color: '#6c757d', borderBottom: '2px solid #dee2e6', padding: '12px', whiteSpace: 'nowrap' }}>Feedback ID</th>
                  ...
                  <th style={{ fontWeight: '500', fontSize: '14px', color: '#6c757d', borderBottom: '2px solid #dee2e6', padding: '12px', whiteSpace: 'nowrap' }}>Title</th>
      ...
      <h2 style={{ color: "#3A5FBE", fontSize: "25px", marginLeft: "15px" }}>Feedback Sent to HR</h2>
              ...
              <tbody>
                {currentSentFeedbacks.map((fb) => (
                  ...
                  >
                    ...
                    <td
                      style={{ padding: '12px', verticalAlign: 'middle', fontSize: '14px', borderBottom: '1px solid #dee2e6', whiteSpace: 'nowrap' }}
          ...
          <div className="modal-dialog" style={{ maxWidth: "500px", width: "95%" }}>
            <div className="modal-content">
                ...
                <div className="mb-3">
                  ...
                  {editId ? (
                    <div className="form-control bg-light">
                      {hrUsers.find(hr => hr._id === formData.receiverId)?.name || "HR Person"}
                    </div>
                  ) : (
                    <select
                      className="form-select"
              ...
              <div className="modal-footer border-0">
                <button className="btn custom-outline-btn" onClick={handleSubmit}>
                  {editId ? "Update" : "Submit Feedback"}
                </button>
                <button className="btn custom-outline-btn" onClick={() => {
                  setShowForm(false);
                  setEditId(null);
                  setErrors({});
                  setFormData({ receiverId: "", title: "", message: "" });
              ...
              <div className="modal-body">
                <div className="container-fluid">
                  <div className="row mb-2">
                    ...
                    <div className="col-sm-8 col-7">{selectedFeedback.feedbackId}</div>
                  </div>

                  {selectedFeedback.type === "received" ? (
                    <div className="row mb-2">
                      <div className="col-5 col-sm-4 fw-semibold">From</div>
                      <div className="col-sm-8 col-7">{selectedFeedback.hrName || "HR"}</div>
                    </div>
                  ) : (
                    <div className="row mb-2">
                      <div className="col-5 col-sm-4 fw-semibold">To</div>
                      <div className="col-sm-8 col-7">{selectedFeedback.assignedTo || "HR"}</div>
                    </div>
                  )}

                  <div className="row mb-2">
                    <div className="col-5 col-sm-4 fw-semibold">Date</div>
                    <div className="col-sm-8 col-7">{selectedFeedback.date}</div>
                  </div>
                  ...
                  {selectedFeedback.readAt && (
                    <div className="row mb-2">
                      ...
                      <div className="col-sm-8 col-7">{selectedFeedback.readAt}</div>
                    </div>
                  )}

                  <div className="row mb-2">
                    <div className="col-5 col-sm-4 fw-semibold">Title</div>
                    <div className="col-sm-8 col-7">{selectedFeedback.title}</div>
                  </div>

                  <div className="row mb-2">
                    <div className="col-5 col-sm-4 fw-semibold">Description</div>
                    <div className="col-sm-8 col-7" style={{ whiteSpace: "pre-wrap" }}>
