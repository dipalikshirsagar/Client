...
const EmployeeFeedback = () => {
  ...
  //     const response = await axios.get("https://server-backend-ems.vercel.app/gethr", {
  //       headers: {
  ...
  const fetchRecipients = async () => {
    try {
      ...
      // 1. Fetch HR users
      const hrResponse = await axios.get("https://server-backend-ems.vercel.app/gethr", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      ...
      try {
        const userResponse = await axios.get(
          `https://server-backend-ems.vercel.app/users/${currentUser._id}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
        ...
        if (userData.role && userData.role.toLowerCase() === "manager") {
          const employeesResponse = await axios.get(
            `https://server-backend-ems.vercel.app/managers/${currentUser._id}/assigned-employees`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
