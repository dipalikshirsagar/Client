...
function Header({ user, handleLogout }) {
 ...
 const location = useLocation();
  ...
  const [activeTab, setActiveTab] = useState(location.pathname.includes('/tms-dashboard') ? "TMS" : "EMS");
...
>
  ...
  to={
    activeTab === "EMS"
      ? `/dashboard/${user.role}/${user.username || user.name}/${user._id}/myprofile`
      : `/tms-dashboard/${user.role}/${user.username || user.name}/${user._id}/myprofile`
  }
