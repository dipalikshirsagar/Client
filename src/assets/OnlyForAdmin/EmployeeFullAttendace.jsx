  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const empRes = await axios.get(` https://server-backend-nu.vercel.app/employees/${empId}`);
...
const completedBreaks = breaks.filter(
  brk => brk.startTime && brk.endTime
);

const hasRunningBreak = breaks.some(
  brk => brk.startTime && !brk.endTime
);
        ...
        >
          <div className="container-fluid">
            ...
            <div className="row mb-3">
              ...
              <div className="col-sm-9">
                {selectedAttendance.employeeCheckInLocation?.address || "N/A"}
              </div>
            </div>
